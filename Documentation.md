...
<br/>
## Scalability
For scalanility, GCP offers Load Balancers which can help us distribute income traffic across multiple VM instances. This will help us scale our starbucks app, and support heavy traffic. LB will also detect and automatically remove unhealthy VM instances, and route traffic to the closest VM.

Other way to scale is add more nodes to our app which can also be done automatically using autoscaling that GCP offers. Since our app is using LB and medium level of nodes, hence we believe that our app will be able to handle large amount of users.
